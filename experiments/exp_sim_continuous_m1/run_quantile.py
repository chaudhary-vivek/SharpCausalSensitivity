...
def exp_function(config_run, datasets, nuisance):
    ...
    plotting.plot_bounds_scm_quantile(gmsm, scm, gamma_dict, n_samples=20000, n_samples_oracle=80000, a_int=[0.9, 0.5], bootstrap=bootstrapping,
                                path_rel="/experiments/exp_sim_continuous_m1/results/plot_exp_continuous_m1_0.9_0.5_q0.3.pdf", q=0.3)
    plotting.plot_bounds_scm_quantile(gmsm, scm, gamma_dict, n_samples=20000, n_samples_oracle=80000, a_int=[0.9, 0.5], bootstrap=bootstrapping,
                                path_rel="/experiments/exp_sim_continuous_m1/results/plot_exp_continuous_m1_0.9_0.5_q0.5.pdf", q=0.5)
    plotting.plot_bounds_scm_quantile(gmsm, scm, gamma_dict, n_samples=20000, n_samples_oracle=80000, a_int=[0.9, 0.5], bootstrap=bootstrapping,
                                path_rel="/experiments/exp_sim_continuous_m1/results/plot_exp_continuous_m1_0.9_0.5_q0.7.pdf", q=0.7)

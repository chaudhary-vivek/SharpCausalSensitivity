...
def exp_function(config_run, datasets, nuisance):
    ...
    plotting.plot_bounds_scm_quantile(gmsm, scm, gamma_dict, n_samples=20000, n_samples_oracle=80000, a_int=[0.2, 0.4, 0.5], bootstrap=bootstrapping,
                                path_rel="/experiments/exp_sim_continuous_m2/results/plot_exp_continuous_m2_0.2_0.4_0.5_q0.3.pdf", q=0.3)
    plotting.plot_bounds_scm_quantile(gmsm, scm, gamma_dict, n_samples=20000, n_samples_oracle=80000, a_int=[0.2, 0.4, 0.5], bootstrap=bootstrapping,
                                path_rel="/experiments/exp_sim_continuous_m2/results/plot_exp_continuous_m2_0.2_0.4_0.5_q0.5.pdf", q=0.5)
    plotting.plot_bounds_scm_quantile(gmsm, scm, gamma_dict, n_samples=20000, n_samples_oracle=80000, a_int=[0.2, 0.4, 0.5], bootstrap=bootstrapping,
                                path_rel="/experiments/exp_sim_continuous_m2/results/plot_exp_continuous_m2_0.2_0.4_0.5_q0.7.pdf", q=0.7)
    return None
